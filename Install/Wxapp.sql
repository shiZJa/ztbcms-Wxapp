...
CREATE TABLE `cms_wxapp_appinfo` (
  ...
  `login_duration` int(11) unsigned NOT NULL DEFAULT '7200',
  `session_duration` int(11) unsigned NOT NULL DEFAULT '2592000' COMMENT 'session存储时长',
  ...
  `office_appid` varchar(128) DEFAULT '' COMMENT '绑定微信公众号appid',
